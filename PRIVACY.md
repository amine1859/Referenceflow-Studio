...
RefFlow Studio is a local-first desktop application. It does not require a RefFlow account and does not send telemetry or board contents to RefFlow Studio servers.
...
Copy, drag-and-drop, and reveal-in-folder actions use Windows and Electron desktop APIs on your device. RefFlow Studio does not transmit clipboard contents to RefFlow Studio servers.

## Your control

You can remove boards and settings from the app, delete exported board folders using Windows Explorer, and revoke or replace any third-party API key. Uninstalling the app may not remove folders that you deliberately exported or configured for autosave.

## Contact

Privacy questions can be raised through the [RefFlow Studio GitHub issue tracker](https://github.com/amine1859/Referenceflow-Studio/issues).
